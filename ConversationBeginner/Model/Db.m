...
{
    int rc;
    NSString *path = [FileUtils documentPath: @"data.jpg"];
    sqlite3 *db;
    
    NSInteger version = [[NSUserDefaults standardUserDefaults] integerForKey: @"db_version"];
    ...
    [[NSUserDefaults standardUserDefaults] setInteger:DB_VERSION forKey:@"db_version"];
...
- (void) copyDb
{
    ...
    NSError *error;
    NSString *dbSrc = [FileUtils resourcePath: @"data.jpg"];
    NSString *dbDst =  [FileUtils documentPath: @"data.jpg"];
