...
NSString *const IAPHelperProductPurchasedNotification4 = @"IAPHelperProductPurchasedNotification";

//20141207. LC v4
//#define kIAPItemProductIdV1      @"com.remapapp.rize.item1"//0.99
//#define kIAPItemProductIdV2      @"com.remapapp.rize.item2"//1.99

@interface VInAppPurchaseController()
...
@implementation VInAppPurchaseController
...
+ (VInAppPurchaseController*)sharedController {
    static VInAppPurchaseController* sController = nil;
    if (sController == nil) {
        sController = [VInAppPurchaseController new];
    }
    return sController;
}
...
- (id)init {
    self = [super init];
    if (self) {
        productIdentifierList = @[kIAPItemProductIdAll, kIAPItemProductIdBook1, kIAPItemProductIdBook2, kIAPItemProductIdBook3, kIAPItemProductIdBook4, kIAPItemProductIdBook5, kIAPItemProductIdBook6, kIAPItemProductIdBook7, kIAPItemProductIdBook8, kIAPItemProductIdBook9, kIAPItemProductIdBook10, kIAPItemProductIdBook11, kIAPItemProductIdBookRemove3, kIAPItemProductIdBookRemove5];
...
- (void)provideContentForProductIdentifier:(NSString *)productIdentifier restore:(BOOL)restore {
    ...
    ////
    [[NSNotificationCenter defaultCenter] postNotificationName:IAPHelperProductPurchasedNotification4 object:nil userInfo:@{IAPHelperProductPurchasedNotification4: productIdentifier}];
}
