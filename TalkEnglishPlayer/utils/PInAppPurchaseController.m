...
NSString *const IAPHelperProductPurchasedNotification5 = @"IAPHelperProductPurchasedNotification";

//20141207. LC v4
//#define kIAPItemProductIdV1      @"com.remapapp.rize.item1"//0.99
//#define kIAPItemProductIdV2      @"com.remapapp.rize.item2"//1.99

@interface PInAppPurchaseController()
...
@implementation PInAppPurchaseController
...
+ (PInAppPurchaseController*)sharedController {
    static PInAppPurchaseController* sController = nil;
    if (sController == nil) {
        sController = [PInAppPurchaseController new];
    }
    return sController;
}
...
- (id)init {
    self = [super init];
    if (self) {
        productIdentifierList = @[kIAPItemOffline, kIAPItemRemoveAds2, kIAPItemDonate2];
...
- (void)provideContentForProductIdentifier:(NSString *)productIdentifier restore:(BOOL)restore {
    ...
    ////
    [[NSNotificationCenter defaultCenter] postNotificationName:IAPHelperProductPurchasedNotification5 object:nil userInfo:@{IAPHelperProductPurchasedNotification5: productIdentifier}];
}
