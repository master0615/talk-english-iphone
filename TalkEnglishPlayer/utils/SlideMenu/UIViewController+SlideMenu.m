...
- (PSlideMenuController*) slideMenuController{
    UIViewController* viewController = self;
    while (viewController != nil) {
        if ([viewController isKindOfClass:[PSlideMenuController class]]) {
            return (PSlideMenuController*)viewController;
        }
...
- (void) toggleLeft{
    PSlideMenuController* menuController = [self slideMenuController];
