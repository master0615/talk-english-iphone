...
#import "LLesson3ViewController.h"
#import "LSentenceContainerView.h"
#import "LWordsContainerView.h"
#import "Lesson3.h"

@interface LLesson3ViewController()<DraggingWordsDelegate>
...
@end
@implementation LLesson3ViewController
...
- (void) viewDidAppear:(BOOL)animated {
    ...
    [LAnalytics sendScreenName:[NSString stringWithFormat: @"Lesson3 Screen - %@", [LLessonContainerViewController singleton].entry.number]];
}
...
- (void)viewWillLayoutSubviews {
    ...
    Lesson3* entry = (Lesson3*)[LLessonContainerViewController singleton].entry;
