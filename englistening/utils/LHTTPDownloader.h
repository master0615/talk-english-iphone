...
#define INSTRUCTION_VIDEO_URL  WEBSERVICE_URL @"/apps/conversation/video/instruction/en_instruction.mp4"
#define INSTRUCTION_VIDEO_NAME  @"en_instruction.mp4"
#define AUDIO_URL WEBSERVICE_URL @"/apps/conversation/audio/"
...
@interface LHTTPDownloader : NSObject
